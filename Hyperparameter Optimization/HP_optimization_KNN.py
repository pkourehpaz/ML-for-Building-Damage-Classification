...
p1=plt.errorbar(n_neighbors, means_train, color='k', yerr=asymmetric_error_train, linewidth=1.0, capsize=1, capthick=1.5)
...
p2=plt.errorbar(n_neighbors, means_test, color=(0.78,0,0), yerr=asymmetric_error_test, linestyle='dashed', linewidth=1.0, capsize=1, capthick=1.5)
...
plt.xlim(0.0, 40.01)
plt.ylim(0.7, 1)               
plt.xlabel('# of Nearest Neighbors', fontsize=9)
