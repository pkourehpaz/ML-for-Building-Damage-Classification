...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  7 16:13:50 2021
...
base_estimator = DecisionTreeClassifier(max_depth=1, max_features=7)
alg = AdaBoostClassifier(base_estimator=base_estimator)


learning_rate = [0.1, 0.2, 0.05, 1, 5]
...
p1=plt.errorbar(n_estimators, means_train, color='k', yerr=asymmetric_error_train, linewidth=1.0, capsize=1, capthick=1.5)
...
p2=plt.errorbar(n_estimators, means_test, color=(0.78,0,0), yerr=asymmetric_error_test, linestyle='dashed', linewidth=1.0, capsize=1, capthick=1.5)
